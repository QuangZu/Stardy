...
class MockTranscriptionService {
    ...
    /**
     * Generate mock chapters for longer content
     * @param {number} duration - Video duration in seconds
     * @param {string} text - Transcription text
     * @returns {Array} - Mock chapters
     */
    ...
    /**
     * Mock the complete YouTube processing workflow
     * @param {string} youtubeUrl - YouTube URL
     * @param {Object} audioInfo - Downloaded audio information
