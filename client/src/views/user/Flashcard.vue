      ...
      <div class="main-content">
        ...
        <div v-if="!studyStarted" class="study-start">
          <div class="start-card">
            ...
            <p>This flashcard set contains {{ flashcardSet.cards.length }} cards to help you learn and memorize key concepts.</p>
...
export default {
  ...
  computed: {
    ...
    progressPercentage() {
      return ((this.currentCardIndex + 1) / this.flashcardSet.cards.length) * 100;
    },
    
    totalCards() {
      return this.flashcardSet.cards.length;
    }
  },
  async mounted() {
  ...
  methods: {
    ...
    nextCard() {
      if (this.currentCardIndex < this.flashcardSet.cards.length - 1) {
