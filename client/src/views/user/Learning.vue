            ...
            >
              ...
              <div class="card-content">
                ...
                <div class="card-meta">
                  ...
                  <span class="meta-item difficulty" :class="quiz.difficulty">
                    <i class="fas fa-signal"></i>
                    {{ quiz.difficulty }}
                  </span>
                </div>
                <div class="card-stats" v-if="quiz.totalAttempts > 0">
          ...
          <div v-else class="content-grid">
            ...
            >
              ...
              <div class="card-content">
                ...
                <div class="card-stats" v-if="flashcardSet.totalStudySessions > 0">
                  <span class="stat-item">
                    <i class="fas fa-clock"></i>
                    Avg Time: {{ flashcardSet.averageSessionTime }}m
                  </span>
                  <span class="stat-item">
                    <i class="fas fa-book-open"></i>
                    {{ flashcardSet.totalStudySessions }} sessions
                  </span>
                </div>
              </div>
              <div class="card-footer">
  ...
  methods: {
    ...
    async loadUserQuizzes() {
      try {
        ...
        this.userQuizzes = await getUserQuizzes(this.userId);
      } catch (error) {
    ...
    async loadUserFlashcards() {
      try {
        ...
        this.userFlashcardSets = await getUserFlashcardSets(this.userId);
      } catch (error) {
