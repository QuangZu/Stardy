        ...
        <div class="note-content-side">
          ...
          <header class="note-header">
            ...
            <div class="ai-action-buttons" v-if="!isEditing">
              <button @click="generateQuiz" class="ai-action-btn quiz" :disabled="aiLoading">
                <i class="fas fa-question-circle"></i>
                <span>Quiz</span>
              </button>
              <button @click="generateFlashcards" class="ai-action-btn flashcards" :disabled="aiLoading">
    ...
    async generateFlashcards() {
      try {
        ...
        this.$router.push({
          ...
          query: {
            tab: 'flashcards',
            newFlashcardSet: result.flashcardSet._id
          }
        });
