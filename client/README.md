...
- **Exam System**: Interactive exam taking and results
...
- **Exams Admin**: Exam creation and administration
...
- **RoleBasedRouter**: Route protection based on user roles
